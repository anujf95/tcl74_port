...
#ifndef lint
//static char sccsid[] = "@(#) tclHistory.c 1.37 95/05/04 11:51:16";
#endif /* not lint */
...
#define INITIAL_CMD_SIZE 16 //XXX: changed default Intital cmd length
    ...
    register Interp *iPtr;		/* Interpreter to initialize. */
{
    ...
    iPtr->numEvents = 5;	//XXX: changed max history events from 20 to 5
