...
//XXX: work around to unsupported dirent.h in newlib
#include "dirent2.h"
 ...
 */
 //XXX: Undefining MAXPATHLEN from POSIX to reduce size
#undef MAXPATHLEN
#define PATH_MAX  32
 ...
 * (see tclUnixUtil.c).
 */
//XXX: No Auto retry since SIGNALS not present
